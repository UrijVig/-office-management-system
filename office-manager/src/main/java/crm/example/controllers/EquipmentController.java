...
import crm.example.services.EquipmentService;
...
public class EquipmentController {
    ...
    public String createEquipmentCard(Model model) {
        ...
        model.addAttribute("equipment", new CreateEquipmentDTO());
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PostMapping("/create")
    public String saveEquipmentCard(@Valid @ModelAttribute("equipment") CreateEquipmentDTO dto,
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PostMapping("/update")
    public String updateEquipmentCard(@Valid @ModelAttribute("equipment") CreateEquipmentDTO dto,
            BindingResult br, Model model) {
        if (br.hasErrors()) {
            model.addAttribute("equipment", dto);
